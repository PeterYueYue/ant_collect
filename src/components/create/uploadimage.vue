<template>
    <div class="uploadimage">
        ...
        <a href="" class="imgbtnortext">
            <!-- 上传图片后隐藏 -->
            <div v-show="headerImage.length<1"  class="upimg">
                <div style=" width:100% ; height:100%;"> 
                     <div class="show"> 
                         <div class="picture" :style="'backgroundImage:url('+headerImage+')'"></div> 
                     </div> 
                     <div style="width:100%;height:100%"> 
                         <input style="width:100%;height:100%;" type="file" id="upload"  accept="image" @change="upload"> 
            ...
            <!-- 上传图片呢后显示 -->
            <div class="showimge">
                <img v-for="item in headerImage" :src="headerImage" alt="">
                <!-- <img src="@/assets/upimg2.png" alt=""> -->
                <div v-show="this.headerImage && headerImage.length<3" class="isaddimg">
